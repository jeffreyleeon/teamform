...
function JoinTeamCtrl(currentUser, teamformDb,$http) {
    ...
    var adminIdObject = teamformDb.getEvent(vm.eventName);
    var adminId = adminIdObject.eventOwner;  

    function sendAdminEmail(){
      console.log(adminId);

      var adminObj = teamformDb.getUser(adminId);
      var adminEmail = adminObj.email;
